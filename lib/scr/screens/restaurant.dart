            ...
            children: <Widget>[
              ...
              Positioned.fill(
                  ...
                  child: Align(
                      alignment: Alignment.bottomCenter,
                      child: CustomText(
                        text: "Average Price: \$" + restaurantModel.avgPrice.toString(),
                        color: white,
                        size: 18,
                        weight: FontWeight.w300,
                      ))),
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: black.withOpacity(0.2)),
                            child: Icon(
                              Icons.close,
                              color: white,
                            )),
...
//              open & book section
          Row(
            ...
            children: <Widget>[
              ...
              Container(child: FlatButton.icon(onPressed: () {}, icon: Icon(Icons.restaurant_menu), label: CustomText(text: "Book Now")))
            ],
          ),
